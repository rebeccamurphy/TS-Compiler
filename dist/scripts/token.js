    ...
    var Token = (function () {
        ...
        Token.getWordMatchToken = function (str, lineNum) {
            ...
            if (str.indexOf('false') > -1) {
                tokenList.push(TSC.Token.createToken(10 /* BOOL */, 'false', lineNum));
            }
            else if (str.indexOf('true') > -1) {
                tokenList.push(TSC.Token.createToken(10 /* BOOL */, 'true', lineNum));
            }
        ...
        Token.getToken = function (str, lineNum) {
            ...
            switch (str) {
                ...
                case '==':
                    return TSC.Token.createToken(24 /* BOOLOP */, str, lineNum);
                case '!=':
                    return TSC.Token.createToken(24 /* BOOLOP */, str, lineNum);
                case '$':
